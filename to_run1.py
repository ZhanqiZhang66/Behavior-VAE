    ...
    for motif in range(n_cluster):
        ...
        for i, j in itertools.combinations(range(len(df_epoch_motif_BD)), 2):
            ...
            if len(latent_vector_BD) == 0 or len(latent_vector_BD2) == 0:
                ...
                BD_BD_distance = wasserstein_distance_nd(latent_vector_BD, latent_vector_BD2)
...
distances_BD_BD_df.to_csv(f'{project_path}/data/Wasserstein_distances_BD_BD_df.csv', index=False)
