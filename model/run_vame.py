...
video_dir = r'C:\Users\zhanq\OneDrive - UC San Diego\Behavior_VAE_data\Participant_videos_attributes\BD-euthymic-25-HC-25'
videos = []
...
config = vame.init_new_project(project='BD25-HC25-final',
                               videos=videos,
...
start_frame = pd.read_csv(r'C:\Users\zhanq\OneDrive - UC San Diego\Behavior_VAE_data\video-information.csv',  usecols=[0,1])
